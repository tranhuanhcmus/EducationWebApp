...
const model = {
  ...
  addForumComment: async (data) => {
    try {
      ...
      const [rows, fields] = await db
        .promise()
        .query(sqlQuery.AddForumComment, [
          data.CmtID,
          data.FID,
          data.ID,
          data.Content,
  ...
  addCourseComment: async (data) => {
    try {
      ...
      const [rows, fields] = await db
        .promise()
        .query(sqlQuery.AddCourseComment, [
          data.CmtID,
          data.CID,
          data.ID,
          data.Content,
  ...
  updateForumComment: async (data) => {
    try {
      ...
      const [rows, fields] = await db
        .promise()
        .query(sqlQuery.UpdateForumComment, [
          data.CmtID,
          data.FID,
          data.ID,
          data.Content,
  ...
  updateCourseComment: async (data) => {
    try {
      ...
      const [rows, fields] = await db
        .promise()
        .query(sqlQuery.UpdateCourseComment, [
          data.CmtID,
          data.CID,
          data.ID,
          data.Content,
  ...
  updateTestComment: async (data) => {
    try {
      ...
      const [rows, fields] = await db
        .promise()
        .query(sqlQuery.UpdateTestComment, [
          data.CmtID,
          data.TID,
          data.ID,
          data.Content,
